...
def realFHR(self, qp, Cache, startCount, endCount, xRatio):
...
def realEHG(self, qp, Cache, startCount, endCount, xRatio):
...
def realMHR(self, qp, Cache, startCount, endCount, xRatio):
...
def realMMov(self, qp, Cache, startCount, endCount, xRatio):
...
def realSNR(self, qp, Cache, startCount, endCount, xRatio):
...
def realEvent(self, qp, Cache, startCount, endCount, xRatio):
...
def drawScales(self, qp, startTime, startCount, endCount, xRatio):
...
def PregSimMMov(self, qp, Cache, startCount, endCount):
    pen = QtGui.QPen(QtGui.QColor(183, 48, 34), 1, QtCore.Qt.SolidLine)
    qp.setPen(pen)
    i=0
    size=self.size()
