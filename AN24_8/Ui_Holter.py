...
#
# Created: Mon May 04 16:03:21 2015
...
class Ui_Holter(object):
    def setupUi(self, Holter):
        ...
        self.pinTest.setGeometry(QtCore.QRect(650, 20, 75, 23))
...
"background-repeat:no-repeat;"))
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(20, 10, 121, 161))
        self.gridLayoutWidget.setObjectName(_fromUtf8("gridLayoutWidget"))
        self.gridLayout = QtGui.QGridLayout(self.gridLayoutWidget)
        self.gridLayout.setMargin(0)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.device_2 = QtGui.QPushButton(self.gridLayoutWidget)
        self.device_2.setObjectName(_fromUtf8("device_2"))
        self.gridLayout.addWidget(self.device_2, 1, 0, 1, 1)
        self.device_3 = QtGui.QPushButton(self.gridLayoutWidget)
        self.device_3.setObjectName(_fromUtf8("device_3"))
        self.gridLayout.addWidget(self.device_3, 2, 0, 1, 1)
        self.device_1 = QtGui.QPushButton(self.gridLayoutWidget)
        self.device_1.setObjectName(_fromUtf8("device_1"))
        self.gridLayout.addWidget(self.device_1, 0, 0, 1, 1)
        self.device_4 = QtGui.QPushButton(self.gridLayoutWidget)
        self.device_4.setObjectName(_fromUtf8("device_4"))
        self.gridLayout.addWidget(self.device_4, 3, 0, 1, 1)
