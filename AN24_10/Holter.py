    ...
    def paintEvent(self, event):        
        ...
        if is_detecting:
            ...
            if end_count>realCount:
                ...
                start_count = 0
            noteDict = self.an24Dict[nameChosen].noteDict
...
#            realEvent(self, qp, Cache, start_count, end_count, self.unitXY['FHR'], self.line_rgb['Event'])       
            ...
            drawNote(self, qp, self.unitXY['FHR'], self.all_count,  start_count,  end_count, self.xyRatio, noteDict)
    ...
    def fill_info(self):
        try:
            ...
            if patient_info:
                self.an24Dict[nameChosen].patient.person_num = patient_info['person_num']
                ...
                send2server(self.an24Dict[nameChosen].patient)
                self.update_patient_info(self.an24Dict[nameChosen])   
                self.infoed = True
                #---------
                self.an24Dict[nameChosen].rawHandler.handle(patient_info, 0)
                #---------
    ...
    def start_detecting(self):
        ...
        try:        
            ...
            if self.an24Dict[nameChosen].is_checked:
                ...
                #-------------------
                self.an24Dict[nameChosen].rawAN24.data_recv(self.an24Dict[nameChosen].rawHandler.handle)
                #-------------------
    ...
    def on_recvStop_clicked(self, checked): 
        try:
            ...
            #---------------
            self.an24Dict[nameChosen].rawAN24.stop_recv(self.an24Dict[nameChosen].rawHandler.handle)    
            #--------------
    ...
    def add_note(self):
        ...
        if is_detecting:
            ...
            self.an24Dict[nameChosen].noteDict[count] = (note_y, note)
            self.repaint()
