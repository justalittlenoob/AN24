...
set shortmess=aoO
badd +0 rfcomm_client.py
badd +21 rfcomm_client2.py
args D:\WorkSpace\Eclipse-workspace\Test_PyDev\src\PyBluezTest\rfcomm\rfcomm_client.py
edit rfcomm_client.py
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((1 * winheight(0) + 13) / 26)
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 23 + 14) / 28)
exe 'vert 1resize ' . ((&columns * 30 + 59) / 119)
exe '2resize ' . ((&lines * 23 + 14) / 28)
exe 'vert 2resize ' . ((&columns * 80 + 59) / 119)
argglobal
enew
file __Tag_List__
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((20 * winheight(0) + 11) / 23)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
