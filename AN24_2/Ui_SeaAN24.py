...
# Form implementation generated from reading ui file 'E:\5-HOLTER\FHR 20150330\_eric4project\SeaAN24.ui'
#
# Created: Mon Mar 30 15:53:32 2015
...
class Ui_SeaAN24(object):
    ...
    def retranslateUi(self, SeaAN24):
        ...
        self.label.setText(_translate("SeaAN24", "<html><head/><body><p><span style=\" font-size:16pt;\">请打开AN24设备</span></p></body></html>", None))
        self.label_2.setText(_translate("SeaAN24", "<html><head/><body><p><span style=\" font-size:16pt;\">并打开手持端设备的蓝牙</span></p></body></html>", None))
        self.pushButton.setText(_translate("SeaAN24", "选择", None))
        self.label_3.setText(_translate("SeaAN24", "<html><head/><body><p>正在选择查找AN24……</p></body></html>", None))
