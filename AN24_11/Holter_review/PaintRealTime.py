...
def cal_ScaleY(window_rect, type, is_print = False,  print_lines = 1, line_no =1):
    if is_print:
    ...
    if type =='FHR':
        ...
        if print_lines ==2:
            if  line_no == 1:
                baseY = 16*ystep - window_height
            if  line_no == 2:
                baseY = 16*ystep
        if print_lines ==3:
            if  line_no == 1:
                baseY = 16*ystep - 2*window_height
            if line_no == 2:
                print 'bingo!'
                baseY = 16*ystep - 2*window_height
            if line_no == 3:
        ...
        if print_lines ==1:
            baseY = 22*ystep
        elif print_lines ==2 and line_no == 1:
            baseY = 22*ystep - window_height
        elif print_lines ==2 and line_no == 2:
            baseY = 22*ystep
        elif print_lines ==3 and line_no == 1:
            baseY = 22*ystep - 2*window_height
        elif print_lines ==3 and line_no == 2:
            baseY = 22*ystep - 2*window_height
        elif print_lines ==3 and line_no == 3:
            baseY = 22*ystep
        height = 6*ystep
        ystep = 1.5*ystep
    elif type =='MHR':
        if print_lines ==1:
            ...
            baseY = 32*ystep - window_height
        elif print_lines ==2 and line_no == 2:
            baseY = 32*ystep
        elif print_lines ==3 and line_no == 1:
            baseY = 32*ystep - 2*window_height
        elif print_lines ==3 and line_no == 2:
            baseY = 32*ystep - 2*window_height
        elif print_lines ==3 and line_no == 3:
            baseY = 32*ystep
        ...
        if print_lines == 1:
            ...
            baseY = 34.5*ystep - window_height
        elif print_lines ==2 and line_no == 2:
            baseY = 34.5*ystep
        elif print_lines ==3 and line_no == 1:
            baseY = 34.5*ystep - 2*window_height
        elif print_lines ==3 and line_no == 2:
            baseY = 34.5*ystep - 2*window_height
        elif print_lines ==3 and line_no == 3:
            baseY = 34.5*ystep
        ...
        if print_lines == 1:
            ...
            baseY = 36*ystep - window_height
        elif print_lines ==2 and line_no == 2:
            baseY = 36*ystep
        elif print_lines ==3 and line_no == 1:
            baseY = 36*ystep - 2*window_height
        elif print_lines ==3 and line_no == 2:
            baseY = 36*ystep - 2*window_height
        elif print_lines ==3 and line_no == 3:
            baseY = 36*ystep
...
def cal_rect(window_rect, scaleY, is_print = False, print_pic_rect = False):
    baseY, height, ystep = scaleY
    if is_print and print_pic_rect:
        window_width = print_pic_rect.height()
        window_height = print_pic_rect.width()
...
def cal_FHRrect(window_rect, FHR_scaleY, FHR_limit, is_print = False, print_pic_rect = False):
    ...
    if is_print:
        ...
        top_rect = (0,FHR_baseY-FHR_scaleY[1]-window_height, window_width, top_line-(FHR_baseY-FHR_scaleY[1])+1) 
