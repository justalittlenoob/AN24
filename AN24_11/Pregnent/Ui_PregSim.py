...
# Form implementation generated from reading ui file 'E:\5-HOLTER\FHR_20150615_edition2.0\_eric4project\PregSim.ui'
#
# Created: Mon Jun 15 21:58:18 2015
...
class Ui_PregSim(object):
    def setupUi(self, PregSim):
        ...
        self.MoHr.setGeometry(QtCore.QRect(210, 70, 181, 81))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Times New Roman"))
        font.setPointSize(28)
        ...
        self.ChHrNum.setGeometry(QtCore.QRect(30, 210, 151, 81))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Times New Roman"))
        ...
        self.ChHrNum.setText(_fromUtf8(""))
        ...
        self.MoHrNum.setText(_fromUtf8(""))
        ...
        self.Bulb.setGeometry(QtCore.QRect(360, 10, 41, 51))
...
"background-repeat: no-repeat"))
    ...
    def retranslateUi(self, PregSim):
        PregSim.setWindowTitle(_translate("PregSim", "Monica", None))
        self.MoBeatmin.setText(_translate("PregSim", "Beat/min", None))
        self.ChHr.setText(_translate("PregSim", "Baby HR", None))
        self.MoHr.setText(_translate("PregSim", "Mother HR", None))
        self.RunTimeNum.setText(_translate("PregSim", "00:00:00", None))
        self.ChBeatmin.setText(_translate("PregSim", "Beat/min", None))
        self.MoMov.setText(_translate("PregSim", "MMov Intensity：1~3/S", None))
        self.pushButton.setText(_translate("PregSim", "Switch", None))
        self.RunTime.setText(_translate("PregSim", "Run Time:", None))
