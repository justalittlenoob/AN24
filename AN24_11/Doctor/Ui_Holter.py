...
# Form implementation generated from reading ui file 'F:\work in 2015 summer\5-HOLTER\mother_20150825_edition3.2\_eric4project\Holter.ui'
#
# Created: Tue Aug 25 13:52:38 2015
...
"border:no;"))
        ...
        self.xscale1.setGeometry(QtCore.QRect(10, 130, 41, 41))
...
"border:no;"))
        ...
        self.xscale2.setGeometry(QtCore.QRect(60, 130, 41, 41))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"border:no"))
        ...
        self.xscale3.setGeometry(QtCore.QRect(120, 130, 41, 41))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"border:no;"))
        ...
        self.pushButtonSettings.setGeometry(QtCore.QRect(10, 200, 71, 71))
...
""))
        ...
        self.pushExit.setGeometry(QtCore.QRect(80, 220, 75, 23))
        self.pushExit.setObjectName(_fromUtf8("pushExit"))
        self.pushGetPatient = QtGui.QPushButton(self.frame)
        self.pushGetPatient.setGeometry(QtCore.QRect(80, 260, 75, 23))
        self.pushGetPatient.setObjectName(_fromUtf8("pushGetPatient"))
        self.pushMulti = QtGui.QPushButton(self.frame)
        self.pushMulti.setGeometry(QtCore.QRect(80, 300, 75, 23))
...
"border-radius:5px;"))
    ...
    def retranslateUi(self, Holter):
        ...
        self.pushGetPatient.setText(_translate("Holter", "get_online_p", None))
